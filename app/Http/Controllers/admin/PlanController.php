...
class PlanController extends Controller
{
  ...
  {
      $services = Service::where('type',3)->paginate(9);


      return view("/dashboard/plans/index",["services"=>  $services ]);
  }
...
//    $service=Service::find
      ...
      return view('dashboard.plans.show',compact('service','service_images'));
