...
class howWorkController extends Controller
{
  ...
  {
      $works = Work::where('type',2)->paginate(9);

      return view("/dashboard/how_works/index",["works"=>  $works ]);
  }
  ...
  {
      return view('/dashboard/how_works/create');
  ...
  public function edit($id)
  {
      ...
      return view('/dashboard/how_works/edit',["work"=>$work]);
  }
