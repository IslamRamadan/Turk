...
<img src="{{asset('front/img/logo2.png')}}">
            ...
            <div class=" login">
                <form  role="form">
                    <div class="form-group">
                        ...
                        <p>do not have account yet <a href="register.html" class="main-color">creat one</a></p>
                    </div>
                </form>
            </div>
        </li>
    ...
    @elseif(Auth::guard('client')->check())
            <li class="nav-item link-login">  <a class="nav-link border-right "  href="{{route('login/client')}}" > <i class="fas fa-user"></i>  {{Auth::guard('client')->user()->email}}</a>


    @endif
 {{--End of modification Islam--}}

<li class="nav-item">  <a class="nav-link  border-right"  href="wishlist.html" > <i class="fas fa-heart"></i> wishlist</a>
</li>
    ...
    <li class="nav-item relative link-login"><a class="nav-link border-right" href="{{route('home')}}" >   
        ...
        <i class="fas fa-chevron-down "></i> </a>
            ...
            <a class="nav-link " href="{{route('home')}}"> <img src="{{asset('front/img/k.svg')}}" width="20">  Kuwait </a>
                 <hr class="mr-0">
            <a class="nav-link " href="index-ar.html"> <img src="{{asset('front/img/k.svg')}}" width="20">  Kuwait </a>
...
<li class="nav-item">  <a class="nav-link "  href="index-ar.html" ><img src="{{asset('front/img/k.svg')}}"  width="30px">  العربية</a>
</li>
</ul> 
...
<div class=" container  ">
    ...
    <ul class="nav  col-9" >
        ...
        <li class="nav-item li1">  <a class="nav-link  "  href="category.html" > category     <i class="fas fa-angle-down"></i>   </a>
    <div class=" li2 pad-0">
 <ul class="navbar-nav  w-100 pad-0" >
       <li class="nav-item li3 pad-10 relative"> 
                        <a class="nav-link  "  href="category.html" > <i class="fas fa-female"></i>  fashion   <i class="fas fa-angle-down"></i>  </a>
                      <div class=" li4 pad-0">
 <ul class="navbar-nav  w-100 pad-0" >
                    <li class="nav-item  pad-10 li5"> 
                        <a class="nav-link  "  href="category.html" > <i class="fas fa-female"></i> men  <i class="fas fa-angle-down"></i>  </a>
                         <div class=" li6 pad-0">
 <ul class="navbar-nav  w-100 pad-0" >
                    <li class="nav-item  pad-10 li7"> 
                        <a class="nav-link  "  href="category.html" > <i class="fas fa-female"></i> clothes</a>
                                      <div class=" li8 pad-0">
 <ul class="navbar-nav  w-100 pad-0" >
       <li class="nav-item  bg-b pad-10"> 
                    ...
                    <li class="nav-item  pad-10"> 
                        <a class="nav-link  "  href="vendor.html" > <img src="{{asset('front/img/h&m.png')}}" width="20px"> H&M</a>
                    </li>
                   <li class="nav-item  pad-10"> 
                        <a class="nav-link  "  href="vendor.html" > <img src="{{asset('front/img/zara.png')}}" width="20px"> zaraa</a>
                    </li>
      <li class="nav-item  pad-10"> 
                        <a class="nav-link  "  href="vendor.html" > <img src="{{asset('front/img/max.png')}}" width="20px"> max</a>
                    </li>
                   ...
                   <li class="nav-item  pad-10"> 
                        <a class="nav-link  "  href="category.html" > <i class="fas fa-female"></i> sub sub category</a>
                    </li>
      <li class="nav-item  pad-10"> 
                        <a class="nav-link  "  href="category.html" > <i class="fas fa-female"></i> sub  sub category</a>
                    </li>
      <li class="nav-item  pad-10"> 
                  ...
                  <li class="nav-item  pad-10 li5"> 
                        <a class="nav-link  "  href="category.html" ><i class="fas fa-female"></i>  women  <i class="fas fa-angle-down"></i>  </a>
                         <div class=" li6 pad-0">
 <ul class="navbar-nav  w-100 pad-0" >
                     <li class="nav-item  pad-10 li7"> 
                        <a class="nav-link  "  href="category.html" > <i class="fas fa-female"></i> clothes</a>
 ...
 <ul class="navbar-nav  w-100 pad-0" >
      ...
      <li class="nav-item  pad-10"> 
       ...
       <li class="nav-item  pad-10 li5"> 
                        <a class="nav-link  "  href="category.html" > <i class="fas fa-female"></i>  shoes  <i class="fas fa-angle-down"></i>  </a>
                         <div class=" li6 pad-0">
 <ul class="navbar-nav  w-100 pad-0" >
                    <li class="nav-item  pad-10"> 
                        <a class="nav-link  "  href="category.html" > <i class="fas fa-female"></i>  sub sub category</a>
      ...
      <li class="nav-item  pad-10"> 
       ...
       <li class="nav-item  pad-10 li5"> 
                        <a class="nav-link  "  href="category.html" ><i class="fas fa-female"></i>  kides  <i class="fas fa-angle-down"></i>  </a>
                         <div class=" li6 pad-0">
 <ul class="navbar-nav  w-100 pad-0" >
                    <li class="nav-item  pad-10"> 
                        <a class="nav-link  "  href="category.html" >  <i class="fas fa-female"></i> sub sub category</a>
      ...
      <li class="nav-item  pad-10"> 
       ...
       <li class="nav-item li3 pad-10 relative"> 
                        <a class="nav-link  "  href="category.html" > <i class="fas fa-female"></i>  beauty   <i class="fas fa-angle-down"></i>  </a>
                      <div class=" li4 pad-0">
 <ul class="navbar-nav  w-100 pad-0" >
                    <li class="nav-item  pad-10 li5"> 
                        <a class="nav-link  "  href="category.html" > <i class="fas fa-female"></i> sub category   <i class="fas fa-angle-down"></i>  </a>
                         <div class=" li6 pad-0">
 <ul class="navbar-nav  w-100 pad-0" >
                    <li class="nav-item  pad-10"> 
                        <a class="nav-link  "  href="category.html" ><i class="fas fa-female"></i> sub sub category</a>
      ...
      <li class="nav-item  pad-10"> 
                   ...
                   <li class="nav-item  pad-10"> 
                        <a class="nav-link  "  href="category.html" > <i class="fas fa-female"></i> sub category</a>
                    </li>
      <li class="nav-item  pad-10"> 
                        <a class="nav-link  "  href="category.html" ><i class="fas fa-female"></i> sub category</a>
                    </li>
      <li class="nav-item  pad-10"> 
                    ...
                    <li class="nav-item  pad-10"> 
                        <a class="nav-link  "  href="category.html" ><i class="fas fa-female"></i>  music</a>
                    </li>
                  
      <li class="nav-item  pad-10"> 
                        <a class="nav-link  "  href="category.html" > <i class="fas fa-female"></i> category</a>
                    </li>
      <li class="nav-item  pad-10"> 
                        <a class="nav-link  "  href="category.html" > <i class="fas fa-female"></i> category</a>
                    </li>
...
<img src="{{asset('front/img/logo2.png')}}">
  ...
  <div class="input-group-append">
    <a class="btn btn-outline-secondary" href=""> <i class="fas fa-search" style="font-size: 20px"></i></a>
     ...
     <!--- sidbar --->
                ...
                <div class="text-center">
                  <a href="login.html" class="btn bg-main">sign in</a> or
                    <a href="register.html" class="btn bg-main">sign up</a> 
                   </div>
    ...
    <li class="nav-item  border-bottom">
          <a class="nav-link   "  href="cart.html" >  <i class="fas fa-shopping-bag" style="font-size: 20px"></i>  cart</a>
    </li>    
 ...
 <li class="nav-item border-bottom"> 
  ...
  <li class="nav-item border-bottom">
      <a class="nav-link " href="account.html">   my account </a></li>
   <li class="nav-item border-bottom"> 
        ...
        <i class="fas fa-chevron-down "></i> </a>
            ...
            <a class="nav-link " href="index-ar.html"> <img src="{{asset('front/img/k.svg')}}" width="20">  Kuwait </a>
                   ...
                   <li class="nav-item   pad-10"> 
                        <a class="nav-link  "  href="category.html" >sub category</a>
                    </li>
      <li class="nav-item "> 
                        <a class="nav-link  pad-10 "  href="category.html" >sub category</a>
                    </li>
      <li class="nav-item  "> 
                        <a class="nav-link   pad-10"  href="category.html" >sub category</a>
                    </li>
          ...
          <h5>Company Information</h5>
              <ul class="navbar-nav  w-100" >
                   ...
                   <li class="nav-item border-bottom "> 
                    ...
                    <li class="nav-item   border-bottom">
                        <a class="nav-link  "  href="delivery.html" >Delivery Terms</a>
                    </li>
                    </ul>  
             <br> <br></div>
     <div class="col-lg-4 col-sm-6 col-12">
